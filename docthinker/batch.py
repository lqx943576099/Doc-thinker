"""
Batch processing functionality for DocThinker
...
class BatchMixin:
    """BatchMixin class containing batch processing functionality for DocThinker"""

    # Type hints for mixin attributes (will be available when mixed into DocThinker)
    config: "DocThinkerConfig"
    logger: logging.Logger

    # Type hints for methods that will be available from other mixins
    async def _ensure_graphcore_initialized(self) -> None: ...
