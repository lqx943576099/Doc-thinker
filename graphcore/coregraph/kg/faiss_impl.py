...
from graphcore.coregraph.utils import logger, compute_mdhash_id
...
class FaissVectorDBStorage(BaseVectorStorage):
    """
    A Faiss-based Vector DB Storage for GraphCore.
    ...
    def client_storage(self):
        # Return whatever structure GraphCore might need for debugging
