...
class PostgreSQLDB:
    ...
    async def _migrate_llm_cache_schema(self):
        ...
        try:
            ...
            WHERE table_name = 'graphcore.coregraph_llm_cache'
    ...
    async def _migrate_doc_chunks_to_vdb_chunks(self):
        ...
        try:
            ...
            WHERE table_name = 'graphcore.coregraph_doc_chunks' AND column_name = 'content_vector'
            """
    ...
    async def _migrate_doc_status_add_chunks_list(self):
        ...
        try:
            ...
            SELECT column_name
            FROM information_schema.columns
            WHERE table_name = 'graphcore.coregraph_doc_status'
    ...
    async def _migrate_text_chunks_add_llm_cache_list(self):
        ...
        try:
            ...
            SELECT column_name
            FROM information_schema.columns
            WHERE table_name = 'graphcore.coregraph_doc_chunks'
    ...
    async def _migrate_doc_status_add_track_id(self):
        ...
        try:
            ...
            SELECT indexname
            FROM pg_indexes
            WHERE tablename = 'graphcore.coregraph_doc_status'
            AND indexname = 'idx_graphcore.coregraph_doc_status_track_id'
            """
            ...
            if not index_info:
                ...
                create_index_sql = """
                CREATE INDEX idx_graphcore.coregraph_doc_status_track_id ON LIGHTRAG_DOC_STATUS (track_id)
                """
    ...
    async def _create_pagination_indexes(self):
        ...
        indexes = [
            {
                "name": "idx_graphcore.coregraph_doc_status_workspace_status_updated_at",
                "sql": "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_graphcore.coregraph_doc_status_workspace_status_updated_at ON LIGHTRAG_DOC_STATUS (workspace, status, updated_at DESC)",
                "description": "Composite index for workspace + status + updated_at pagination",
            },
            {
                "name": "idx_graphcore.coregraph_doc_status_workspace_status_created_at",
                "sql": "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_graphcore.coregraph_doc_status_workspace_status_created_at ON LIGHTRAG_DOC_STATUS (workspace, status, created_at DESC)",
                "description": "Composite index for workspace + status + created_at pagination",
            },
            {
                "name": "idx_graphcore.coregraph_doc_status_workspace_updated_at",
                "sql": "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_graphcore.coregraph_doc_status_workspace_updated_at ON LIGHTRAG_DOC_STATUS (workspace, updated_at DESC)",
                "description": "Index for workspace + updated_at pagination (all statuses)",
            },
            {
                "name": "idx_graphcore.coregraph_doc_status_workspace_created_at",
                "sql": "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_graphcore.coregraph_doc_status_workspace_created_at ON LIGHTRAG_DOC_STATUS (workspace, created_at DESC)",
                "description": "Index for workspace + created_at pagination (all statuses)",
            },
            {
                "name": "idx_graphcore.coregraph_doc_status_workspace_id",
                "sql": "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_graphcore.coregraph_doc_status_workspace_id ON LIGHTRAG_DOC_STATUS (workspace, id)",
                "description": "Index for workspace + id sorting",
            },
            {
                "name": "idx_graphcore.coregraph_doc_status_workspace_file_path",
                "sql": "CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_graphcore.coregraph_doc_status_workspace_file_path ON LIGHTRAG_DOC_STATUS (workspace, file_path)",
...
class PGGraphStorage(BaseGraphStorage):
    ...
    async def upsert_edge(
        ...
        query = """SELECT * FROM cypher('%s', $$
            ...
            tgt_label,
            edge_properties,
            edge_properties,  # https://github.com/HKUDS/GraphCore/issues/1438#issuecomment-2826000195
        )
