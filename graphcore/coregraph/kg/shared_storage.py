...
from graphcore.coregraph.exceptions import PipelineNotInitializedError
...
def direct_log(message, enable_output: bool = True, level: str = "DEBUG"):
    ...
    # Get the current logger level from the graphcore.coregraph logger
    try:
        from graphcore.coregraph.utils import logger

        current_level = logger.getEffectiveLevel()
    except ImportError:
        # Fallback if graphcore.coregraph.utils is not available
