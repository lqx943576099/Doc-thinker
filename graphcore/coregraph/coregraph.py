...
@dataclass
class GraphCore:
    """GraphCore: Simple and Fast Retrieval-Augmented Generation."""
    ...
    # TODO: Deprecated (GraphCore will never initialize storage automatically on creation，and finalize should be call before destroying)
    auto_manage_storages_states: bool = field(default=False)
    """If True, graphcore.coregraph will automatically calls initialize_storages and finalize_storages at the appropriate times."""
    ...
    def __post_init__(self):
        ...
        logger.debug(f"GraphCore init with param:\n  {_print_config}\n")
    ...
    async def initialize_storages(self):
        ...
        if self._storages_status == StoragesStatus.CREATED:
            ...
            if default_workspace is None:
                ...
                logger.info(
                    f"Creating GraphCore instance with workspace='{self.workspace}' "
    ...
    async def adelete_by_entity(self, entity_name: str) -> DeletionResult:
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from graphcore.coregraph.utils_graph import adelete_by_entity
    ...
    async def adelete_by_relation(
        ...
        Returns:
            DeletionResult: An object containing the outcome of the deletion process.
        """
        from graphcore.coregraph.utils_graph import adelete_by_relation
    ...
    async def get_entity_info(
        ...
        from graphcore.coregraph.utils_graph import get_entity_info
    ...
    async def get_relation_info(
        ...
        from graphcore.coregraph.utils_graph import get_relation_info
    ...
    async def aedit_entity(
        ...
        """
        from graphcore.coregraph.utils_graph import aedit_entity
    ...
    async def aedit_relation(
        ...
        """
        from graphcore.coregraph.utils_graph import aedit_relation
    ...
    async def acreate_entity(
        ...
        """
        from graphcore.coregraph.utils_graph import acreate_entity
    ...
    async def acreate_relation(
        ...
        """
        from graphcore.coregraph.utils_graph import acreate_relation
    ...
    async def amerge_entities(
        ...
        """
        from graphcore.coregraph.utils_graph import amerge_entities
    ...
    async def aexport_data(
        ...
        """
        from graphcore.coregraph.utils import aexport_data as utils_aexport_data
