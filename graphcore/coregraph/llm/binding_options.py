...
from graphcore.coregraph.constants import DEFAULT_TEMPERATURE
...
# in GraphCore. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        """
        Generate a sample .env file for all GraphCore binding options.
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for GraphCore binding options\n"
                "#\n"
                "# To generate run:\n"
                "# $ python -m graphcore.coregraph.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
        ...
        sample_bottom = (
            ("#\n# End of .env entries for GraphCore binding options\n")
            + "#" * 80
            + "\n"
        )
...
#
# Usage:
#   python -m graphcore.coregraph.llm.binding_options           # Generate .env sample
#   python -m graphcore.coregraph.llm.binding_options test      # Test argument parsing
#
# =============================================================================
